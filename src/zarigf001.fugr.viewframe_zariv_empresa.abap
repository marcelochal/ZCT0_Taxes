*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZARIV_EMPRESA
*   generation date: 30.08.2018 at 13:50:22
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZARIV_EMPRESA       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZARIV_EMPRESA'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZARIV_EMPRESA_EXTRACT
TOTAL = ZARIV_EMPRESA_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZARIV_EMPRESA'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZARIV_EMPRESA-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_EMPRESA_EXTRACT
TOTAL = ZARIV_EMPRESA_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZARIV_EMPRESA-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZARIV_EMPRESA'
...
TOTAL = ZARIV_EMPRESA_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZARIV_EMPRESA-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZARIV_EMPRESA-UPD_FLAG NE SPACE.
