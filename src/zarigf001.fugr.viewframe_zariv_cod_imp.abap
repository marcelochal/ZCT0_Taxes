*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZARIV_COD_IMP
*   generation date: 30.08.2018 at 12:02:37
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZARIV_COD_IMP       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZARIV_COD_IMP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZARIV_COD_IMP_EXTRACT
TOTAL = ZARIV_COD_IMP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZARIV_COD_IMP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZARIV_COD_IMP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_COD_IMP_EXTRACT
TOTAL = ZARIV_COD_IMP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZARIV_COD_IMP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZARIV_COD_IMP'
...
TOTAL = ZARIV_COD_IMP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZARIV_COD_IMP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZARIV_COD_IMP-UPD_FLAG NE SPACE.
