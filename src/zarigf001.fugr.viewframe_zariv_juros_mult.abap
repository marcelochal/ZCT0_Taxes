*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZARIV_JUROS_MULT
*   generation date: 30.08.2018 at 12:45:25
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZARIV_JUROS_MULT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZARIV_JUROS_MULT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZARIV_JUROS_MULT_EXTRACT
TOTAL = ZARIV_JUROS_MULT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZARIV_JUROS_MULT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZARIV_JUROS_MULT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_JUROS_MULT_EXTRACT
TOTAL = ZARIV_JUROS_MULT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZARIV_JUROS_MULT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZARIV_JUROS_MULT'
...
TOTAL = ZARIV_JUROS_MULT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZARIV_JUROS_MULT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZARIV_JUROS_MULT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZARIV_JUROS_MULT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZARIV_JUROS_MULT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_JUROS_MULT_EXTRACT
TOTAL = ZARIV_JUROS_MULT_TOTAL
