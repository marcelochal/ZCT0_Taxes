*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZARIV_INTERVALO
*   generation date: 30.08.2018 at 12:31:43
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZARIV_INTERVALO     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZARIV_INTERVALO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZARIV_INTERVALO_EXTRACT
TOTAL = ZARIV_INTERVALO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZARIV_INTERVALO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZARIV_INTERVALO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_INTERVALO_EXTRACT
TOTAL = ZARIV_INTERVALO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZARIV_INTERVALO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZARIV_INTERVALO'
...
TOTAL = ZARIV_INTERVALO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZARIV_INTERVALO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZARIV_INTERVALO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZARIV_INTERVALO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZARIV_INTERVALO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZARIV_INTERVALO_EXTRACT
TOTAL = ZARIV_INTERVALO_TOTAL
